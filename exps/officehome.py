class NewConf(object):
    ...
    to_be_replaced = dict(
        ...
        ckpt_path=[
            ...
            "./pretrained_ckpts/classification/resnet50_with_head/officehome/rn50_bn_art.pth",
            "./pretrained_ckpts/classification/resnet50_with_head/officehome/rn50_bn_art.pth",
            "./pretrained_ckpts/classification/resnet50_with_head/officehome/rn50_bn_clipart.pth",
            "./pretrained_ckpts/classification/resnet50_with_head/officehome/rn50_bn_clipart.pth",
            "./pretrained_ckpts/classification/resnet50_with_head/officehome/rn50_bn_clipart.pth",
            "./pretrained_ckpts/classification/resnet50_with_head/officehome/rn50_bn_product.pth",
            "./pretrained_ckpts/classification/resnet50_with_head/officehome/rn50_bn_product.pth",
            "./pretrained_ckpts/classification/resnet50_with_head/officehome/rn50_bn_product.pth",
